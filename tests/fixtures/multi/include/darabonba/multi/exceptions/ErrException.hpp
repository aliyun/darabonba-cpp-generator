...
#ifndef DARABONBA_MULTI_EXCEPTIONS_ERREXCEPTION_HPP_
#define DARABONBA_MULTI_EXCEPTIONS_ERREXCEPTION_HPP_
...
namespace Exceptions
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const ERRException& obj) { 
