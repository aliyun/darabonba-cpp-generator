...
namespace Models
{
  ...
  public:
    ...
    inline const M::SubM & subM() const { DARABONBA_PTR_GET_CONST(subM_, M::SubM) };
    inline M::SubM subM() { DARABONBA_PTR_GET(subM_, M::SubM) };
  ...
  protected:
    std::shared_ptr<M::SubM> subM_ = nullptr;
  };
