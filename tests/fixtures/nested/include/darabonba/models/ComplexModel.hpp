...
namespace Models
{
  ...
  public:
    ...
    public:
      ...
      inline const vector<Record::RecordItem> & record() const { DARABONBA_PTR_GET_CONST(record_, vector<Record::RecordItem>) };
      inline vector<Record::RecordItem> record() { DARABONBA_PTR_GET(record_, vector<Record::RecordItem>) };
    ...
    protected:
      ...
      std::shared_ptr<vector<Record::RecordItem>> record_ = nullptr;
    };
    ...
    inline ComplexModel& setHasRecord(bool hasRecordValue) { DARABONBA_PTR_SET_VALUE(hasRecord_, hasRecordValue) };


    // record Field Functions 
    bool hasRecord() const { return this->record_ != nullptr;};
    void deleteRecord() { this->record_ = nullptr;};
    inline const ComplexModel::Record & record() const { DARABONBA_PTR_GET_CONST(record_, ComplexModel::Record) };
    inline ComplexModel::Record record() { DARABONBA_PTR_GET(record_, ComplexModel::Record) };
  ...
  protected:
    std::shared_ptr<bool> hasRecord_ = nullptr;
    std::shared_ptr<ComplexModel::Record> record_ = nullptr;
  };
