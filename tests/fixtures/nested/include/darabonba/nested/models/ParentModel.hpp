...
#ifndef DARABONBA_NESTED_MODELS_PARENTMODEL_HPP_
#define DARABONBA_NESTED_MODELS_PARENTMODEL_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline const ParentModel::ParentModelItem & getParentModel() const { DARABONBA_PTR_GET_CONST(parentModel_, ParentModel::ParentModelItem) };
    inline ParentModel::ParentModelItem getParentModel() { DARABONBA_PTR_GET(parentModel_, ParentModel::ParentModelItem) };
  ...
  protected:
    ...
    shared_ptr<ParentModel::ParentModelItem> parentModel_ {};
  };
