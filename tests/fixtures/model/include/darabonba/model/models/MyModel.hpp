...
#ifndef DARABONBA_MODEL_MODELS_MYMODEL_HPP_
#define DARABONBA_MODEL_MODELS_MYMODEL_HPP_
#include <darabonba/Core.hpp>
#include <vector>
#include <map>
#include <darabonba/model/models/MyModelSubmodel.hpp>
#include <darabonba/model/models/M.hpp>
#include <darabonba/source.hpp>
#include <darabonba/model/models/MSubM.hpp>
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const MyModel& obj) { 
      ...
      DARABONBA_TO_JSON(bytesfield, bytesfield_);
    ...
    friend void from_json(const Darabonba::Json& j, MyModel& obj) { 
      ...
      DARABONBA_FROM_JSON(bytesfield, bytesfield_);
    ...
    public:
      ...
      inline string getStringfield() const { DARABONBA_PTR_GET_DEFAULT(stringfield_, "") };
      ...
      inline const Submodel::Model & getModel() const { DARABONBA_PTR_GET_CONST(model_, Submodel::Model) };
      inline Submodel::Model getModel() { DARABONBA_PTR_GET(model_, Submodel::Model) };
    ...
    protected:
      shared_ptr<string> stringfield_ {};
      shared_ptr<Submodel::Model> model_ {};
    };
    ...
    public:
      ...
      bool hasModel() const { return this->model_ != nullptr;};
      void deleteModel() { this->model_ = nullptr;};
      inline const Model::ModelItem & getModel() const { DARABONBA_PTR_GET_CONST(model_, Model::ModelItem) };
      inline Model::ModelItem getModel() { DARABONBA_PTR_GET(model_, Model::ModelItem) };
    ...
    protected:
      shared_ptr<string> str_ {};
      shared_ptr<Model::ModelItem> model_ {};
    };

    virtual bool empty() const override { return this->model_ == nullptr
        && this->stringfield_ == nullptr && this->bytesfield_.empty() && this->stringarrayfield_ == nullptr && this->mapfield_ == nullptr && this->name_ == nullptr
    ...
    bool hasModel() const { return this->model_ != nullptr;};
    void deleteModel() { this->model_ = nullptr;};
    inline const MyModel::Model & getModel() const { DARABONBA_PTR_GET_CONST(model_, MyModel::Model) };
    inline MyModel::Model getModel() { DARABONBA_PTR_GET(model_, MyModel::Model) };
    ...
    bool hasBytesfield() const { return !this->bytesfield_.empty();};
    void deleteBytesfield() { this->bytesfield_.clear();};
    inline Darabonba::Bytes getBytesfield() const { DARABONBA_GET(bytesfield_) };
    ...
    inline const vector<string> & getStringarrayfield() const { DARABONBA_PTR_GET_CONST(stringarrayfield_, vector<string>) };
    inline vector<string> getStringarrayfield() { DARABONBA_PTR_GET(stringarrayfield_, vector<string>) };
    ...
    inline const map<string, string> & getMapfield() const { DARABONBA_PTR_GET_CONST(mapfield_, map<string, string>) };
    inline map<string, string> getMapfield() { DARABONBA_PTR_GET(mapfield_, map<string, string>) };
    ...
    inline const MyModel::Submodel & getSubmodel() const { DARABONBA_PTR_GET_CONST(submodel_, MyModel::Submodel) };
    inline MyModel::Submodel getSubmodel() { DARABONBA_PTR_GET(submodel_, MyModel::Submodel) };
    ...
    inline const map<string, MyModelSubmodel> & getSubmodelMap() const { DARABONBA_PTR_GET_CONST(submodelMap_, map<string, MyModelSubmodel>) };
    inline map<string, MyModelSubmodel> getSubmodelMap() { DARABONBA_PTR_GET(submodelMap_, map<string, MyModelSubmodel>) };
    ...
    inline const map<string, M> & getMapModel() const { DARABONBA_PTR_GET_CONST(mapModel_, map<string, M>) };
    inline map<string, M> getMapModel() { DARABONBA_PTR_GET(mapModel_, map<string, M>) };
    ...
    inline const vector<MyModel::Subarraymodel> & getSubarraymodel() const { DARABONBA_PTR_GET_CONST(subarraymodel_, vector<MyModel::Subarraymodel>) };
    inline vector<MyModel::Subarraymodel> getSubarraymodel() { DARABONBA_PTR_GET(subarraymodel_, vector<MyModel::Subarraymodel>) };
    ...
    inline const vector<M> & getSubarray() const { DARABONBA_PTR_GET_CONST(subarray_, vector<M>) };
    inline vector<M> getSubarray() { DARABONBA_PTR_GET(subarray_, vector<M>) };
    ...
    inline const vector<vector<M>> & getSsubarray() const { DARABONBA_PTR_GET_CONST(ssubarray_, vector<vector<M>>) };
    inline vector<vector<M>> getSsubarray() { DARABONBA_PTR_GET(ssubarray_, vector<vector<M>>) };
    ...
    inline const vector<vector<shared_ptr<TestSource::Source>>> & getSsubmarray() const { DARABONBA_PTR_GET_CONST(ssubmarray_, vector<vector<shared_ptr<TestSource::Source>>>) };
    inline vector<vector<shared_ptr<TestSource::Source>>> getSsubmarray() { DARABONBA_PTR_GET(ssubmarray_, vector<vector<shared_ptr<TestSource::Source>>>) };
    ...
    inline const vector<vector<shared_ptr<TestSource::Source>>> & getSssubmarray() const { DARABONBA_PTR_GET_CONST(sssubmarray_, vector<vector<shared_ptr<TestSource::Source>>>) };
    inline vector<vector<shared_ptr<TestSource::Source>>> getSssubmarray() { DARABONBA_PTR_GET(sssubmarray_, vector<vector<shared_ptr<TestSource::Source>>>) };
    ...
    inline const vector<vector<TestSource::Models::Request>> & getSsubmmarray() const { DARABONBA_PTR_GET_CONST(ssubmmarray_, vector<vector<TestSource::Models::Request>>) };
    inline vector<vector<TestSource::Models::Request>> getSsubmmarray() { DARABONBA_PTR_GET(ssubmmarray_, vector<vector<TestSource::Models::Request>>) };
    ...
    inline const vector<vector<vector<TestSource::Models::Request>>> & getSssubmmarray() const { DARABONBA_PTR_GET_CONST(sssubmmarray_, vector<vector<vector<TestSource::Models::Request>>>) };
    inline vector<vector<vector<TestSource::Models::Request>>> getSssubmmarray() { DARABONBA_PTR_GET(sssubmmarray_, vector<vector<vector<TestSource::Models::Request>>>) };
    ...
    inline const vector<Darabonba::Json> & getMaparray() const { DARABONBA_PTR_GET_CONST(maparray_, vector<Darabonba::Json>) };
    inline vector<Darabonba::Json> getMaparray() { DARABONBA_PTR_GET(maparray_, vector<Darabonba::Json>) };
    ...
    inline const vector<map<string, shared_ptr<TestSource::Source>>> & getMapsubmarray() const { DARABONBA_PTR_GET_CONST(mapsubmarray_, vector<map<string, shared_ptr<TestSource::Source>>>) };
    inline vector<map<string, shared_ptr<TestSource::Source>>> getMapsubmarray() { DARABONBA_PTR_GET(mapsubmarray_, vector<map<string, shared_ptr<TestSource::Source>>>) };
    ...
    inline const map<string, TestSource::Models::Request> & getModuleModelMap() const { DARABONBA_PTR_GET_CONST(moduleModelMap_, map<string, TestSource::Models::Request>) };
    inline map<string, TestSource::Models::Request> getModuleModelMap() { DARABONBA_PTR_GET(moduleModelMap_, map<string, TestSource::Models::Request>) };
    ...
    inline const vector<map<string, TestSource::Models::Request>> & getArrModuleModelMap() const { DARABONBA_PTR_GET_CONST(arrModuleModelMap_, vector<map<string, TestSource::Models::Request>>) };
    inline vector<map<string, TestSource::Models::Request>> getArrModuleModelMap() { DARABONBA_PTR_GET(arrModuleModelMap_, vector<map<string, TestSource::Models::Request>>) };
    ...
    inline const vector<vector<map<string, TestSource::Models::Request>>> & getArrsModuleModelMap() const { DARABONBA_PTR_GET_CONST(arrsModuleModelMap_, vector<vector<map<string, TestSource::Models::Request>>>) };
    inline vector<vector<map<string, TestSource::Models::Request>>> getArrsModuleModelMap() { DARABONBA_PTR_GET(arrsModuleModelMap_, vector<vector<map<string, TestSource::Models::Request>>>) };
    ...
    bool hasSubModelMap() const { return this->subModelMap_ != nullptr;};
    void deleteSubModelMap() { this->subModelMap_ = nullptr;};
    inline const map<string, MSubM> & getSubModelMap() const { DARABONBA_PTR_GET_CONST(subModelMap_, map<string, MSubM>) };
    inline map<string, MSubM> getSubModelMap() { DARABONBA_PTR_GET(subModelMap_, map<string, MSubM>) };
    ...
    inline const map<string, M> & getModelMap() const { DARABONBA_PTR_GET_CONST(modelMap_, map<string, M>) };
    inline map<string, M> getModelMap() { DARABONBA_PTR_GET(modelMap_, map<string, M>) };
    ...
    inline const map<string, shared_ptr<TestSource::Source>> & getModuleMap() const { DARABONBA_PTR_GET_CONST(moduleMap_, map<string, shared_ptr<TestSource::Source>>) };
    inline map<string, shared_ptr<TestSource::Source>> getModuleMap() { DARABONBA_PTR_GET(moduleMap_, map<string, shared_ptr<TestSource::Source>>) };
    ...
    inline const Darabonba::Json & getObject() const { DARABONBA_PTR_GET_CONST(object_, Darabonba::Json) };
    inline Darabonba::Json getObject() { DARABONBA_PTR_GET(object_, Darabonba::Json) };
    ...
    inline shared_ptr<Darabonba::IStream> getReadable() const { DARABONBA_GET(readable_) };
    ...
    inline shared_ptr<Darabonba::OStream> getWritable() const { DARABONBA_GET(writable_) };
    ...
    inline const M & getExistModel() const { DARABONBA_PTR_GET_CONST(existModel_, M) };
    inline M getExistModel() { DARABONBA_PTR_GET(existModel_, M) };
    ...
    inline const Darabonba::Http::Request & getRequest() const { DARABONBA_PTR_GET_CONST(request_, Darabonba::Http::Request) };
    inline Darabonba::Http::Request getRequest() { DARABONBA_PTR_GET(request_, Darabonba::Http::Request) };
    ...
    inline const vector<vector<string>> & getComplexList() const { DARABONBA_PTR_GET_CONST(complexList_, vector<vector<string>>) };
    inline vector<vector<string>> getComplexList() { DARABONBA_PTR_GET(complexList_, vector<vector<string>>) };
    ...
    inline int64_t getNumberfield() const { DARABONBA_PTR_GET_DEFAULT(numberfield_, 0) };
    ...
    inline int32_t getIntegerField() const { DARABONBA_PTR_GET_DEFAULT(integerField_, 0) };
    ...
    inline float getFloatField() const { DARABONBA_PTR_GET_DEFAULT(floatField_, 0.0) };
    ...
    inline double getDoubleField() const { DARABONBA_PTR_GET_DEFAULT(doubleField_, 0.0) };
    ...
    inline int64_t getLongField() const { DARABONBA_PTR_GET_DEFAULT(longField_, 0L) };
    ...
    inline const ulong & getUlongField() const { DARABONBA_PTR_GET_CONST(ulongField_, ulong) };
    inline ulong getUlongField() { DARABONBA_PTR_GET(ulongField_, ulong) };
    ...
    inline int8_t getInt8Field() const { DARABONBA_PTR_GET_DEFAULT(int8Field_, 0) };
    ...
    inline int16 getInt16Field() const { DARABONBA_PTR_GET_DEFAULT(int16Field_, 0) };
    ...
    inline int32_t getInt32Field() const { DARABONBA_PTR_GET_DEFAULT(int32Field_, 0) };
    ...
    inline int64_t getInt64Field() const { DARABONBA_PTR_GET_DEFAULT(int64Field_, 0L) };
    ...
    inline uint8 getUint8Field() const { DARABONBA_PTR_GET_DEFAULT(uint8Field_, 0) };
    ...
    inline uint16_t getUint16Field() const { DARABONBA_PTR_GET_DEFAULT(uint16Field_, 0) };
    ...
    inline uint32_t getUint32Field() const { DARABONBA_PTR_GET_DEFAULT(uint32Field_, 0) };
    ...
    inline uint64_t getUint64Field() const { DARABONBA_PTR_GET_DEFAULT(uint64Field_, 0L) };
  ...
  protected:
    shared_ptr<MyModel::Model> model_ {};
    shared_ptr<string> stringfield_ {};
    Darabonba::Bytes bytesfield_ {};
    shared_ptr<vector<string>> stringarrayfield_ {};
    shared_ptr<map<string, string>> mapfield_ {};
    shared_ptr<string> name_ {};
    shared_ptr<MyModel::Submodel> submodel_ {};
    shared_ptr<map<string, MyModelSubmodel>> submodelMap_ {};
    shared_ptr<map<string, M>> mapModel_ {};
    shared_ptr<vector<MyModel::Subarraymodel>> subarraymodel_ {};
    shared_ptr<vector<M>> subarray_ {};
    shared_ptr<vector<vector<M>>> ssubarray_ {};
    shared_ptr<vector<vector<shared_ptr<TestSource::Source>>>> ssubmarray_ {};
    shared_ptr<vector<vector<shared_ptr<TestSource::Source>>>> sssubmarray_ {};
    shared_ptr<vector<vector<TestSource::Models::Request>>> ssubmmarray_ {};
    shared_ptr<vector<vector<vector<TestSource::Models::Request>>>> sssubmmarray_ {};
    shared_ptr<vector<Darabonba::Json>> maparray_ {};
    shared_ptr<vector<map<string, shared_ptr<TestSource::Source>>>> mapsubmarray_ {};
    shared_ptr<map<string, TestSource::Models::Request>> moduleModelMap_ {};
    shared_ptr<vector<map<string, TestSource::Models::Request>>> arrModuleModelMap_ {};
    shared_ptr<vector<vector<map<string, TestSource::Models::Request>>>> arrsModuleModelMap_ {};
    shared_ptr<map<string, MSubM>> subModelMap_ {};
    shared_ptr<map<string, M>> modelMap_ {};
    shared_ptr<map<string, shared_ptr<TestSource::Source>>> moduleMap_ {};
    shared_ptr<Darabonba::Json> object_ {};
    shared_ptr<Darabonba::IStream> readable_ {};
    shared_ptr<Darabonba::OStream> writable_ {};
    shared_ptr<M> existModel_ {};
    shared_ptr<Darabonba::Http::Request> request_ {};
    shared_ptr<vector<vector<string>>> complexList_ {};
    shared_ptr<int64_t> numberfield_ {};
    shared_ptr<int32_t> integerField_ {};
    shared_ptr<float> floatField_ {};
    shared_ptr<double> doubleField_ {};
    shared_ptr<int64_t> longField_ {};
    shared_ptr<ulong> ulongField_ {};
    shared_ptr<int8_t> int8Field_ {};
    shared_ptr<int16> int16Field_ {};
    shared_ptr<int32_t> int32Field_ {};
    shared_ptr<int64_t> int64Field_ {};
    shared_ptr<uint8> uint8Field_ {};
    shared_ptr<uint16_t> uint16Field_ {};
    shared_ptr<uint32_t> uint32Field_ {};
    shared_ptr<uint64_t> uint64Field_ {};
