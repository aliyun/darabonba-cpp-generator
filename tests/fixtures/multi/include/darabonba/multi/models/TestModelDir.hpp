...
#ifndef DARABONBA_MULTI_MODELS_TESTMODELDIR_HPP_
#define DARABONBA_MULTI_MODELS_TESTMODELDIR_HPP_
...
namespace Models
{
  ...
  public:
    ...
    inline     const Darabonba::Json & getA() const { DARABONBA_GET(a_) };
    Darabonba::Json & getA() { DARABONBA_GET(a_) };
...
namespace Models
{
  ...
  public:
    ...
    inline const Darabonba::Model::User::Models::Info & getM() const { DARABONBA_PTR_GET_CONST(m_, Darabonba::Model::User::Models::Info) };
    inline Darabonba::Model::User::Models::Info getM() { DARABONBA_PTR_GET(m_, Darabonba::Model::User::Models::Info) };
  ...
  protected:
    ...
    shared_ptr<Darabonba::Model::User::Models::Info> m_ {};
  };
