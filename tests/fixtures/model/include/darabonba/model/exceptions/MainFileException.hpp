...
#ifndef DARABONBA_MODEL_EXCEPTIONS_MAINFILEEXCEPTION_HPP_
#define DARABONBA_MODEL_EXCEPTIONS_MAINFILEEXCEPTION_HPP_
#include <darabonba/Core.hpp>
#include <darabonba/Exception.hpp>
#include <map>
#include <darabonba/model/models/Model.hpp>
#include <darabonba/model/models/MainFileModel.hpp>
using namespace std;
